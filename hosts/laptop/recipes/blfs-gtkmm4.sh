...
#   ctx: user:
#   REVIEWED [drop]: Book's own text is explicitly conditional: 'If you have built the documentation ... it was installed to /usr/share/doc/gtkmm-4.0.' No Doxygen here (Optional dep, not built), so that directory never exists -- real failure confirmed: 'mv: cannot stat /usr/share/doc/gtkmm-4.0: No such file or directory'.

...
# source : book/13.1/chapter10/kernel.html
# title  : 10.3 Linux-7.1.8
...
#   ctx: to the unpacked linux-7.1.8 directory. However, we do not recommend this option. It is
...
# --- block 3 --------------------------------------------------
#   ctx: ules, module configuration in /etc/modprobe.d may be required. Information pertaining to
#   ctx: modules and kernel configuration is located in Section 9.3, “Overview of Device and
#   ctx: Module Handling” and in the kernel documentation in the linux-7.1.8/Documentation
...
cp -v arch/x86/boot/bzImage /boot/vmlinuz-7.1.8-lfs-13.1-systemd

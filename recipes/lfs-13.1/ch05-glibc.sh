...
# source : book/13.1/chapter05/glibc.html
# title  : 5.5 Glibc-2.44
# The driver supplies unpack/cd/cleanup. Commands below are in-package only.
# Disabled blocks are tagged with the reason; review before enabling.
set -e

# --- block 0 --------------------------------------------------
#   ctx: ry, searching directories, opening and closing files, reading and writing files, string
#   ctx: handling, pattern matching, arithmetic, and so on. Approximate build time: 1.3 SBU
#   ctx: Required disk space: 900 MB 5.5.1 Installation of Glibc First, create a symbolic link

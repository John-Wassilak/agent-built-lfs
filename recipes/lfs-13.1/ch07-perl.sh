...
# source : book/13.1/chapter07/perl.html
# title  : 7.9 Perl-5.44.0
...
#   ctx: build time: 0.6 SBU Required disk space: 301 MB 7.9.1 Installation of Perl Prepare Perl
#   ctx: for compilation:
sh Configure -des                                         \
             -D prefix=/usr                               \
             -D vendorprefix=/usr                         \
...
#   ctx: MAJOR.MINOR version of Perl (5.44) which allows upgrading Perl to newer patch levels
#   ctx: (the patch level is the last dot separated part in the full version string like 5.44.0)

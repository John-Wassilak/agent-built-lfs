...
# source : book/13.1/chapter07/cleanup.html
# title  : 7.15 Cleaning up and Saving the Temporary System
# The driver supplies unpack/cd/cleanup. Commands below are in-package only.
# Disabled blocks are tagged with the reason; review before enabling.
set -e

# --- block 0 --------------------------------------------------
#   ctx: 7.15.1 Cleaning First, remove the currently installed documentation files to prevent

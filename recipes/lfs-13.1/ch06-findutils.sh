...
# source : book/13.1/chapter06/findutils.html
# title  : 6.8 Findutils-4.11.0
# The driver supplies unpack/cd/cleanup. Commands below are in-package only.
# Disabled blocks are tagged with the reason; review before enabling.
set -e

# --- block 0 --------------------------------------------------
#   ctx: ee and to create, maintain, and search a database (often faster than the recursive find,
...
#   ctx: a search. Approximate build time: 0.2 SBU Required disk space: 51 MB 6.8.1 Installation

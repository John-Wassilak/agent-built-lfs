...
# source : book/13.1/chapter06/xz.html
# title  : 6.16 Xz-5.8.3
...
#   ctx: commands. Approximate build time: 0.1 SBU Required disk space: 24 MB 6.16.1 Installation
#   ctx: of Xz Prepare Xz for compilation:

...
# source : book/blfs-13.1/general/git.html
# title  : Git-2.55.0
# The driver supplies unpack/cd/cleanup. Commands below are in-package only.
set -e

# --- block 0 --------------------------------------------------
#   ctx: to connect to a SMTP server with SSL encryption), and Systemd-261.2 (runtime, rebuilt
...
NO_RUST=1 ./configure --prefix=/usr                   \
...
NO_RUST=1 make perllibdir=/usr/lib/perl5/5.44/site_perl install

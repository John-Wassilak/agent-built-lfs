...
# source : book/blfs-13.1/postlfs/gnupg.html
# title  : GnuPG-2.5.21
# The driver supplies unpack/cd/cleanup. Commands below are in-package only.
set -e

# --- block 0 --------------------------------------------------
#   ctx: s protocol) and pinentry-1.3.3 (Run-time requirement for most of the package's
#   ctx: functionality) Optional cURL-8.21.0, Fuse-3.18.2, ImageMagick-7.1.2-13 (for the convert
#   ctx: utility, used for generating the documentation), libusb-1.0.30, an MTA, texlive-20260301
...
# --- block 1 --------------------------------------------------
#   ctx: If you have texlive-20260301 installed and you wish to create documentation in the pdf

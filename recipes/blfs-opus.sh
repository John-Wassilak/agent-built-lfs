...
# source : book/blfs-13.1/multimedia/opus.html
# title  : Opus-1.6.1
...
#   ctx: MB (with tests) Estimated build time: 0.5 SBU (with tests) Optional Doxygen-1.18.0 and
#   ctx: texlive-20260301 (or install-tl-unx) Installation of Opus Install Opus by running the

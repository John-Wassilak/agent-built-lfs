...
# source : x/x7driver.html (Xorg Libinput Driver section), read against both 13.0 and 13.1
#
# Why this cannot be book(). x/x7driver.html builds a whole set of packages in one

...
# source : book/blfs-13.1/general/libxml2.html
# title  : libxml2-2.15.3
...
#   ctx: to do complete testing. libxml2 Dependencies Recommended ICU-78.3 Optional (for
#   ctx: generating the documentation) Doxygen-1.18.0 and libxslt-1.1.45 Installation of libxml2
...
#   ctx: libxslt-1.1.45 and Doxygen-1.18.0 installed, and run:
...
# --- block 6 --------------------------------------------------
#   ctx: against the static library for the project, including the references to the ICU-78.3
...
#   ctx: against some ICU-78.3 library, then those packages will need a rebuild if ICU is

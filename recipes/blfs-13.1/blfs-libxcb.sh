...
# source : book/blfs-13.1/x/libxcb.html
# title  : libxcb-1.17.0
...
#   ctx: libXau-1.0.12 and xcb-proto-1.17.0 Recommended libXdmcp-1.1.5 (required for Mesa-26.1.7)
#   ctx: Optional Doxygen-1.18.0 (to generate API documentation) and libxslt-1.1.45 Installation

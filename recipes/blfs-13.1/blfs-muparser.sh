...
# source : book/blfs-13.1/lxqt/muparser.html
# title  : muparser-2.3.5
# The driver supplies unpack/cd/cleanup. Commands below are in-package only.
set -e

# --- block 0 --------------------------------------------------
#   ctx: ing an LFS 13.1 platform. Package Information Download (HTTP):
...
#   ctx: CMake-4.4.2 Installation of muparser Install muparser by running the following commands:
mkdir -v build &&
cd       build &&

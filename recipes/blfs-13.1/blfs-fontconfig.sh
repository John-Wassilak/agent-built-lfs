...
# source : book/blfs-13.1/general/fontconfig.html
# title  : Fontconfig-2.18.3
...
#   ctx: texlive-20260301 installed, or the Fontconfig build will fail. Installation of
...
#   ctx: support user namespaces. Some tests will download some font files via Internet. Now, as
#   ctx: the root user:
make install

...
# source : book/blfs-13.1/x/xkeyboard-config.html
# title  : XKeyboardConfig-2.48
# The driver supplies unpack/cd/cleanup. Commands below are in-package only.
set -e

# --- block 0 --------------------------------------------------
#   ctx: 79b589abe4aff6c4bff4782 Download size: 932 KB Estimated disk space required: 35 MB
#   ctx: Estimated build time: 0.1 SBU (with tests) XKeyboardConfig Dependencies Required Xorg
#   ctx: Libraries Optional (required for tests) libxkbcommon-1.13.2, pytest-9.1.1 with
...
# --- block 1 --------------------------------------------------
#   ctx: To test the results, issue: ninja test. Important If upgrading from version 2.44 or
#   ctx: earlier, the installation will fail if some files are not symbolic links. To fix this,
#   ctx: run as the root user:

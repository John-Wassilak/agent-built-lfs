...
# source : book/blfs-13.1/general/nasm.html
# title  : NASM-3.02
# The driver supplies unpack/cd/cleanup. Commands below are in-package only.
set -e

# --- block 0 --------------------------------------------------
#   ctx: 5559188c Download size: 1.5 MB Estimated disk space required: 72 MB Estimated build
#   ctx: time: 0.2 SBU Additional Downloads Optional documentation:
#   ctx: https://www.nasm.us/pub/nasm/releasebuilds/3.02/nasm-3.02-xdoc.tar.xz NASM Dependencies

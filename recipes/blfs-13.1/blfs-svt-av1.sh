...
# source : book/blfs-13.1/multimedia/svt-av1.html
# title  : SVT-AV1-4.2.0
...
#   ctx: Required CMake-4.4.2 Recommended NASM-3.02 Optional Valgrind-3.27.1 Note An Internet
...
#   ctx: known to fail. The test harness will download a copy of libaom (even if libaom-3.14.1 is

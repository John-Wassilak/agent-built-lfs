...
# source : book/blfs-13.1/multimedia/libva.html
# title  : libva-2.24.1
# The driver supplies unpack/cd/cleanup. Commands below are in-package only.
set -e

# --- block 0 --------------------------------------------------
#   ctx: Us or later and Intel Arc GPUs), and Mesa-26.1.7 (providing the r600, radeonsi, and
...
#   ctx: to break it) Optional Doxygen-1.18.0, Wayland-1.26.0, and intel-gpu-tools Installation

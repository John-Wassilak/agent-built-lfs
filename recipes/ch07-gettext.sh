...
# source : book/13.1/chapter07/gettext.html
...
# --- block 0 --------------------------------------------------
#   ctx: ins utilities for internationalization and localization. These allow programs to be
#   ctx: compiled with NLS (Native Language Support), enabling them to output messages in the
#   ctx: user's native language. Approximate build time: 1.5 SBU Required disk space: 531 MB

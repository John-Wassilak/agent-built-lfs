...
# source : book/13.1/chapter08/gdbm.html
# title  : 8.41 GDBM-1.26
# The driver supplies unpack/cd/cleanup. Commands below are in-package only.
# Disabled blocks are tagged with the reason; review before enabling.
set -e

# --- block 0 --------------------------------------------------
#   ctx: ontains the GNU Database Manager. It is a library of database functions that uses
...
#   ctx: 8.41.1 Installation of GDBM Prepare GDBM for compilation:

...
# Runtime deps (via --no-deps, installed as separate steps in this same closure): click, click-log, requests, aiohttp, aiostream, tenacity.
...
pip3 install --no-index --find-links dist --no-user vdirsyncer
